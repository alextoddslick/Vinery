...
public class DrinkBlockItem extends BlockItem {
    ...
    @Override
    public void appendHoverText(@NotNull ItemStack stack, Item.@NotNull TooltipContext tooltipContext, @NotNull TooltipDisplay tooltipDisplay, @NotNull Consumer<Component> tooltip, @NotNull TooltipFlag tooltipFlag) {
        Level world = null;
    ...
    public void inventoryTick(ItemStack stack, ServerLevel level, Entity entity, @Nullable EquipmentSlot equipmentSlot) {
        ...
        if (level != null && stack.get(DataComponentRegistry.WINE_YEAR.get()) == null) {
